...
export const TestimonialCard = ({ review }: { review: TestimonialType }) => (
  <div className="mb-10 ml-10 rounded-lg bg-light-gradient p-2 py-4 shadow-custom-light dark:bg-dark-gradient dark:shadow-custom-dark md:min-w-96 md:px-8 md:py-10">
    <div className="mb-6">
      <Image
